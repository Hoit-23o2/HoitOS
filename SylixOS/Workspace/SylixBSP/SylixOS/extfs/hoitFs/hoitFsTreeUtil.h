...
PHOIT_RB_TREE hoitRbInitTree(VOID);
PHOIT_RB_NODE hoitRbInsertNode(PHOIT_RB_TREE, PHOIT_RB_NODE);
PHOIT_RB_NODE hoitRbSearchNode(PHOIT_RB_TREE, INT32);
BOOL          hoitRbDeleteNode(PHOIT_RB_TREE, PHOIT_RB_NODE);
